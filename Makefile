...
all: cleanapps ni2http  ts2na na2ts na2ni edi2eti eti2zmq
...
cleanapps:
	rm -f $(OBJS_EDI2ETI) $(OBJS_TS2NA) $(OBJS_TS2NA_DREAMBOX) $(OBJS_NA2NI) $(OBJS_NI2HTTP) $(OBJS_ETI2ZMQ)
	rm -f ts2na na2ts na2ni ni2http edi2eti eti2zmq
